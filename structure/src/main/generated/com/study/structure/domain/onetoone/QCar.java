...
public class QCar extends EntityPathBase<Car> {
    ...
    private static final long serialVersionUID = 1386915400L;
    ...
    public final QMainEngine mainEngine;
    ...
    public QCar(Class<? extends Car> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mainEngine = inits.isInitialized("mainEngine") ? new QMainEngine(forProperty("mainEngine"), inits.get("mainEngine")) : null;
    }
